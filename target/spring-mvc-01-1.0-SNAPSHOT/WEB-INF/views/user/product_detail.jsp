        ...
        <div class="well well-small">
            ...
            <div id="myTabContent" class="tab-content tabWrapper">
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <c:if test="${productsByIdCategory.size() > 6}">
                    ...
                    <c:forEach var="item" items="${productsByIdCategory}" begin="1" end="${countlist}" varStatus="loop">
                        <div class="row-fluid">
                            ...
                            <div class="span4 alignR">
                                <form class="form-horizontal qtyFrm">
                                    ...
                                    <div class="btn-group">
                                        <a href="<c:url value="chi-tiet-san-pham/${item.id_product}"/>" class="defaultBtn"><span class=" icon-shopping-cart"></span> Thêm vào giỏ hàng</a>
                        ...
                        <div class="span4 alignR">
                            <form class="form-horizontal qtyFrm">
                                ...
                                <div class="btn-group">
                                    <a href="<c:url value="chi-tiet-san-pham/${item.id_product}"/>" class="defaultBtn"><span class=" icon-shopping-cart"></span> Add to cart</a>
                                    <a href="<c:url value="chi-tiet-san-pham/${item.id_product}"/>" class="shopBtn">VIEW</a>
                                </div>
                            </form>
                        </div>

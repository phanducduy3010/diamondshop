...
<div class="row">
    <div id="sidebar" class="span3">
        ...
        <div class="well well-small"><a href="#"><img src="../../webapp/assets/user/img/paypal.jpg"
        ...
        <ul class="nav nav-list promowrapper">
            <li>
                <div class="thumbnail">
                    ...
                    <img src="../../webapp/assets/user/img/bootstrap-ecommerce-templates.png"
                ...
                <div class="well">
                    <form:form action="checkout" method="post" modelAttribute="bill" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <form:input path="phone" type="text" placeholder=" Field name"/>
                            </div>
                        </div>
                        <div class="control-group">
